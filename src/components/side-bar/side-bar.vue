    ...
    >
      <div class="px-8">
        <div class="h-16 w-full flex items-center">
          <h1 class="text-gray-400 font-bold text-2xl py-12">Covid-Tracker</h1>
        </div>
        <ul class="mt-20">
          <li
            class="
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"><router-link to="/overview">Dashboard</router-link></span>
            </div>
          </li>
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/report">Statistics</router-link> </span>
            </div>
          </li>
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/team">Test & Result</router-link> </span>
            </div>
          </li>
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/schedule">Alerts</router-link> </span>
            </div>
            <div
              class="
                py-1
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/messagepage">Messages</router-link> </span>
            </div>
            <div
              class="
                py-1
          ...
          <li
            ...
            "
          >
            <div class="flex items-center text-r">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span class="text-sm ml-2"> <router-link to="/settings">Settings</router-link> </span>
            </div>
          </li>
        </ul>
        ...
        <ul class="mt-12">
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/board">Dashboard</router-link> </span>
            </div>
            <div
              class="
                py-1
          ...
          >
            <div class="flex items-center">
              ...
              <span class="textprojectpage"> <router-link to="/project">Projects</router-link> </span>
            </div>
            <div
              class="
                py-1
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/task"> Tasks </router-link> </span>
            </div>
          </li>
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/report">Reports</router-link> </span>
            </div>
          </li>
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <router-link to="/schedulepage">Schedule</router-link> </span>
            </div>
          </li>
          <li
            class="
          ...
          >
            <div class="flex items-center">
              ...
              <span class="text-sm ml-2"> <route-link>Messages</route-link> </span>
            </div>
            <div
              class="
                py-1
